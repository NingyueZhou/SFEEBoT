...
def run_single_sf_pca(wb_sf_dfs):
    ...
    for tissue in tissue_2_wb_tissue_df:
        ...
        for sf_ensembl in sf_ensembl_ids:  #for sf_ensembl in five_random_sf:
            ...
            param_grid = {'l1_ratio': [0.3, 0.5, 0.8],#np.arange(0, 1, 0.1),
                          'alpha': [1e-2, 1e-1, 1.0, 1.5]}
...
def run_single_sf_cluster(wb_sf_dfs):
    ...
    for tissue in tissue_2_wb_tissue_df:
        print(f'\n------------------- tissue: {tissue}, en M (CF + NORM + PSI)-----------------------\n')
        sf_name_list = []
        M_mean_R2_list = []
        M_std_R2_list = []
        M_95_ci_list = []
    ...
    plt.xticks(rotation=90)
    plt.ylabel('R2 score')
    plt.title(f'R2 scores of en M RBM20 across tissues')
    plt.tight_layout()
    plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_M_RBM20_bar.png')
    plt.show()
    ...
    for tissue in tissue_2_M_df:
        ...
        for sf_name in M_df['sf_name']:
            ...
            cv_inner = KFold(n_splits=n_folds, shuffle=True, random_state=0)
            cv_outer = KFold(n_splits=n_folds, shuffle=True, random_state=0)
            alphas = list(set([1.0, M_df.loc[M_df['sf_name'] == sf_name, 'M_best_alpha'].values[0],
...
def analyse_result_cluster(results):
    ...
    print('------------------- Result analysis (en, cluster) -----------------------')
    #'''
    for tissue in tissue_2_result_df:
        ...
        if result_df.empty == True:
            ...
            plt.legend()
            plt.title(f'EN M0, M1, M2 performance in {tissue} (cluster)')
            plt.tight_layout()
            plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m012_all_sf_bar_{tissue}_cluster.png')
            plt.show()
            # ------------------------------------
            ...
            plt.xticks(rotation=90)
            plt.ylabel('R2 score')
            plt.title(f'EN M0 performance in {tissue} (cluster)')
            plt.tight_layout()
            plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m0_all_sf_bar_{tissue}_cluster.png')
            plt.show()
            # ------------------------------------
            ...
            plt.xticks(rotation=90)
            plt.ylabel('R2 score')
            plt.title(f'EN M1 performance in {tissue} (cluster)')
            plt.tight_layout()
            plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m1_all_sf_bar_{tissue}_cluster.png')
            plt.show()
            # ------------------------------------
            ...
            plt.xticks(rotation=90)
            plt.ylabel('R2 score')
            plt.title(f'EN M2 performance in {tissue} (cluster)')
            plt.tight_layout()
            plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m2_all_sf_bar_{tissue}_cluster.png')
            plt.show()
            ...
            if result_df[result_df['tissue_specific'] == 1].shape[0] > 0:
                ...
                plt.xticks(x, u, rotation=90)
                plt.legend()
                plt.title(f'EN M0, M1, M2 performance of tissue specific SFs in {tissue} (cluster)')
                plt.tight_layout()
                plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m012_tissue_speci_sf_bar_{tissue}_cluster.png')
                plt.show()
                ...
                plt.xticks(rotation=90)
                plt.ylabel('R2 score')
                plt.title(f'EN M1 performance in {tissue} on tissue specific SF (cluster)')
                plt.tight_layout()
                plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m1_tissue_speci_sf_bar_{tissue}_cluster.png')
                plt.show()
                ...
                plt.xticks(rotation=90)
                plt.ylabel('R2 score')
                plt.title(f'EN M2 performance in {tissue} on tissue specific SF (cluster)')
                plt.tight_layout()
                plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m2_tissue_speci_sf_bar_{tissue}_cluster.png')
                plt.show()
            ...
            if result_df[result_df['M1_significant_M0'] == 1].shape[0] > 0:
                ...
                plt.xticks(x, u, rotation=90)
                plt.legend()
                plt.title(f'EN M0, M1, M2 performance in {tissue} on M1 to M0 significant SF (cluster)')
                plt.tight_layout()
                plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m012_sf_m1_signif_m0_bar_{tissue}_cluster.png')
                plt.show()
                ...
                plt.xticks(rotation=90)
                plt.ylabel('R2 score')
                plt.title(f'EN M1 performance in {tissue} on M1 to M0 significant SF (cluster)')
                plt.tight_layout()
                plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m1_tissue_m0_signif_bar_{tissue}_cluster.png')
                plt.show()
            ...
            if result_df[result_df['M2_significant_M0'] == 1].shape[0] > 0:
                ...
                plt.xticks(x, u, rotation=90)
                plt.legend()
                plt.title(f'EN M0, M1, M2 performance in {tissue} on M2 to M0 significant SF (cluster)')
                plt.tight_layout()
                plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m012_sf_m2_signif_m0_bar_{tissue}_cluster.png')
                plt.show()
                ...
                plt.xticks(rotation=90)
                plt.ylabel('R2 score')
                plt.title(f'EN M2 performance in {tissue} on M2 to M0 significant SF (cluster)')
                plt.tight_layout()
                plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m2_tissue_m0_signif_bar_{tissue}_cluster.png')
                plt.show()
            ...
            plt.title(f'EN occurrences of top 50 important feature genes in {tissue} (cluster)')
            plt.tight_layout()
            plt.savefig(f'/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_impo_feat_gene_count_bar_{tissue}_cluster.png')
            plt.show()
            ...
            if result_df.loc[result_df['M2_mean_R2_score'] >= M2_performance_threshold].shape[0] == 0:
                ...
                try:
                    ...
                    with open(f'/nfs/home/students/ge52qoj/SFEEBoT/output/gene_list/en_most_predictable_sfs_{tissue}.txt', 'w') as f:
                    ...
                    enr = gp.enrichr(gene_list=gene_ids_df['Gene name'].values.tolist(),
                                     ...
                                     organism='Human',
                                     description= f'en_{tissue}',# + '_' + tissue,
                                     outdir='/nfs/home/students/ge52qoj/SFEEBoT/output/enrichr_kegg',
                                     cutoff=adjusted_p_value_cutoff,
                                     no_plot=True)
                    barplot(enr.res2d, title='KEGG_2021_Human', cutoff=adjusted_p_value_cutoff, ofname=f'/nfs/home/students/ge52qoj/SFEEBoT/output/enrichr_kegg/en_cluster_{tissue}_kegg_bar.png')
                except:
                ...
                for sf_name in result_df['sf_name']:
                    ...
                    try:
                        if len(result_df.loc[result_df['sf_name'] == sf_name, 'most_important_feature_genes'].values.tolist()[0]) > 0:
                            ...
                            if '/' in sf_name:
                                with open('/nfs/home/students/ge52qoj/SFEEBoT/output/gene_list/en_most_impo_feat_genes_{}_{}.txt'.format(tissue, sf_name.split('/')[0]), 'w') as f:
                                    for gene in queries:
                                        f.write(gene + '\n')
                            else:
                                with open(f'/nfs/home/students/ge52qoj/SFEEBoT/output/gene_list/en_most_impo_feat_genes_{tissue}_{sf_name}.txt', 'w') as f:
                                    for gene in queries:
                                        f.write(gene + '\n')
                            ...
                            if gene_ids_df.shape[0] > 0:
                                enr = gp.enrichr(gene_list=gene_ids_df['Gene name'].values.tolist(),
                                                 ...
                                                 organism='Human',
                                                 description= f'en_{tissue}_{sf_name}',# + '_'+ tissue + '_' + sf_name,
                                                 outdir='/nfs/home/students/ge52qoj/SFEEBoT/output/enrichr_kegg',
                                                 cutoff=0.5,  # test dataset, use lower value from range(0,1)
                                                 no_plot = True)
                                #print(enr.results.head(3))
                                if '/' in sf_name:
                                    barplot(enr.res2d, title='KEGG_2021_Human', cutoff=0.5, ofname='/nfs/home/students/ge52qoj/SFEEBoT/output/enrichr_kegg/en_cluster_{}_{}_kegg_bar.png'.format(tissue, sf_name.split('/')[0]))
                                else:
                                    barplot(enr.res2d, title='KEGG_2021_Human', cutoff=0.5, ofname=f'/nfs/home/students/ge52qoj/SFEEBoT/output/enrichr_kegg/en_cluster_{tissue}_{sf_name}_kegg_bar.png')
                                #dotplot(enr.res2d, title='KEGG_2016', cutoff=0.01, cmap='viridis_r', ofname=f'/nfs/home/students/ge52qoj/SFEEBoT/output/enrichr_kegg/en_cluster_{tissue}_{sf_name}_kegg_dot.png')
                    except:
    ...
    # ------------------------------------
    tissue_2_result_df = {key: df for key, df in tissue_2_result_df.items() if (df['M1_mean_R2_score']<0).values.any() == False and (df['M2_mean_R2_score']<0).values.any() == False}
    big_result_df = pd.concat(tissue_2_result_df.values())
    ...
    plt.xlabel('')
    plt.xticks(rotation=90)
    plt.title('EN M1 performance of all SF (cluster)')
    plt.tight_layout()
    plt.savefig('/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m1_vio_all_sf_cluster.png')
    plt.show()
    # ------------------------------------
    ...
    plt.xlabel('')
    plt.xticks(rotation=90)
    plt.title('EN M2 performance of all SF (cluster)')
    plt.tight_layout()
    plt.savefig('/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m2_vio_all_sf_cluster.png')
    plt.show()
    ...
    if big_result_df[big_result_df['tissue_specific'] == 1].shape[0] > 0:
        ...
        plt.xlabel('')
        plt.xticks(rotation=90)
        plt.title('EN M1 performance of tissue specific SF (cluster)')
        plt.tight_layout()
        plt.savefig('/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m1_vio_tissue_speci_sf_cluster.png')
        plt.show()
        # ------------------------------------
        ...
        plt.xlabel('')
        plt.xticks(rotation=90)
        plt.title('EN M2 performance of tissue specific SF (cluster)')
        plt.tight_layout()
        plt.savefig('/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m2_vio_tissue_speci_sf_cluster.png')
        plt.show()
    ...
    if big_result_df[big_result_df['M2_significant_M0'] == 1].shape[0] > 0:
        ...
        plt.xlabel('')
        plt.xticks(rotation=90)
        plt.title('en M2 performance of M2 to M0 significant SF (cluster)')
        plt.tight_layout()
        plt.savefig('/nfs/home/students/ge52qoj/SFEEBoT/output/fig/en/en_r2_m2_vio_m0_signif_sf_cluster.png')
        plt.show()
